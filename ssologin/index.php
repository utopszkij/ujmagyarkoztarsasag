 ...
 * 1.régi fiók összekapcsolása SSO -val 
 *    - user.params -ba (JSON) beirni az SSOid -t
 *    - checkUser a user.params alapján is próbáljon keresni
 * 2. Az SSO beli hitelesitési info: $userData->assurances  - tárolása a user.activation adatba
 
 
 HIBÁK:  utf-8 kodlap beállítása a regitformnál
 regist formban email és assurance üres - talán javitva
 regist form feldogozásban sql hiba  - talán javitva
