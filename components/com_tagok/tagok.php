<?php
/**
 * @version $Id: #component#.php 125 2012-10-09 11:09:48Z michel $ 1 2014-05-06Z FT $
* @package	Tagok
...
$config 	=& JComponentHelper::getParams( 'com_tagok' );

$controller = JRequest::getWord('view', 'tagoklist');
...
$classname    = 'TagokController'.$controller;
$controller   = new $classname($ControllerConfig );

// Perform the Request task
$controller->execute( JRequest::getVar( 'task','browse' ) );
