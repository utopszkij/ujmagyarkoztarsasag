...
/**
 * KepviselokModelKepviselok
 * @author $Author$
 */
 
 
class KepviselokModelKepviselok  extends JModelItem { 

	
	
	protected $context = 'com_kepviselok.kepviselok';   
	/**
	...
	public function populateState()
	{
		...
		$this->setState('kepviselok.id', $id);
	...
	protected function getStoreId($id = '')
	{
		...
		$id	.= ':'.$this->getState('kepviselok.id');
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Kepviselok', 'Table');
