...
$task = JRequest::getWord('task','form');


$config 	=& JComponentHelper::getParams( 'com_beallitasok' );
...
$classname    = 'BeallitasokController'.$controller;
$controller   = new $classname($ControllerConfig );

// Perform the Request task
$controller->execute( JRequest::getVar( 'task','form' ) );
