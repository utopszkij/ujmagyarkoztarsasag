<?php
/** 
 *	iCagenda Globalization nl-NL (DUTCH)
 *----------------------------------------------------------------------------
...
defined( '_JEXEC' ) or die( 'Restricted access' );
			...
			$dateglobalize_7 = 'maandag 22 april 1996';
			$datevalue_7 = 'l _ j _ F _ Y';

			$dateglobalize_8 = 'maandag 22 april';
			$datevalue_8 = 'l _ j _ F';

			$dateglobalize_11 = 'ma 22 apr 1996';
			$datevalue_11 = 'D _ j _ M _ Y';

			$dateglobalize_12 = 'ma 22 apr';
