<?php
/**
* @version		$Id: modules.php 118 2012-10-02 08:52:27Z michel $
* @package		Jacc
* @subpackage 	Tables
...
class TableModules extends JTable
{
   ...
   public $use = null;
	...
	{
		parent::__construct('#__jacc_modules', 'id', $db);
	}
	...
	*/
	...
	public function check()
	{
		...
		/**
		if (trim($this->name) == '') {
			$this->setError(JText::_('Your Modules must contain a name.')); 
			return false;
		}
		**/		
