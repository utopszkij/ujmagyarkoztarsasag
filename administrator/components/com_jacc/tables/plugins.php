<?php
/**
* @version		$Id: plugins.php 118 2012-10-02 08:52:27Z michel $
* @package		Jacc
* @subpackage 	Tables
...
class TablePlugins extends JTable
{
   ...
   public $use = null;
	...
	{
		parent::__construct('#__jacc_plugins', 'id', $db);
	}
	...
	*/
	...
	public function check()
	{
		...
		if (trim($this->name) == '') {
			$this->setError(JText::_('Your Plugins must contain a name.')); 
			return false;
		}
