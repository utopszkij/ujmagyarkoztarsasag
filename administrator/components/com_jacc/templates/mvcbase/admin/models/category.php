 ...
 * @subpackage	com_##component##_categories
 * @since 1.5
 */
class ##Component##ModelCategory extends JModelLegacy
{
	/**
	...
	*/
	public function &getTable($type = 'Category', $prefix = 'JTable##Component##', $config = array())
	{
	...
	protected function _populateState()
	{
		...
		if (!($parentId = $app->getUserState('com_##component##_categories.edit.category.parent_id'))) {
	...
	public function getForm()
	{
		...
		$data = $app->getUserState('com_##component##_categories.edit.category.data', array());
