...
?>
<form action="<?php echo JRoute::_('index.php?option=com_##component##&view=categories&extension='.$extension);?>" method="post" id="adminForm" name="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<div class="filter-select fltrt  pull-right"">
			<select name="extension" class="inputbox" onchange="this.form.submit()">
				<?php echo JHtml::_('##component##.extensions', $extension);?>
			</select>
			...
			foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="indent-<?php echo intval(($item->level-1)*15)+4; ?>">
						...
						<a href="<?php echo JRoute::_('index.php?option=com_##component##&task=category.edit&cid[]='.$item->id.'&extension='.$extension);?>">
