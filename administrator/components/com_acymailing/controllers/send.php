...
class SendController extends acymailingController{
	...
	function schedule(){
		...
		if(!ACYMAILING_J30){
			$js = "window.top.document.getElementById('toolbar-Schedule').innerHTML = '<a class=\"toolbar\" onclick=\"javascript: submitbutton(\'unschedule\')\" href=\"#\"><span class=\"icon-32-unschedule\" title=\"".JText::_('UNSCHEDULE',true)."\"> </span>".JText::_('UNSCHEDULE')."</a>';";
		}else{
			$js = "window.top.document.getElementById('toolbar-Schedule').innerHTML = '<div id=\"toolbar-unschedule\" class=\"btn-group\"><button class=\"btn btn-small\" onclick=\"Joomla.submitbutton(\'unschedule\');\" href=\"#\"><i class=\"icon-unschedule \"> </i>Unschedule</button></div>';";
		}
