...
?><fieldset>
	...
	<div class="toolbar" id="toolbar" style="float: right;">
		...
		<?php } ?>
		<td><a href="<?php $link = $app->isAdmin() ? 'diagram&task=mailing' : 'frontnewsletter&task=stats&listid='.JRequest::getInt('listid'); echo acymailing_completeLink($link.'&mailid='.JRequest::getInt('filter_mail'),true); ?>" ><span class="icon-32-cancel" title="<?php echo JText::_('ACY_CANCEL',true); ?>"></span><?php echo JText::_('ACY_CANCEL'); ?></a></td>
		</tr></table>
	</div>
</fieldset>
