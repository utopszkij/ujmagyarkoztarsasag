	...
	<table width="100%">
		...
		<tr>
			...
			<td style="padding-top:10px;">
				<button type="submit" class="btn btn-primary" onclick="var val = document.getElementById('message_receivers').value; if(val != ''){ setUser(val); }" ><?php echo JText::_('SEND_TEST')?></button>
			</td>
		</tr>
	</table>
</fieldset>
