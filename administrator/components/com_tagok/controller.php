...
class TagokController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_tagok&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_tagok&view='.$this->_viewname;
				break;
		}
