...
//include Helper
require_once(JPATH_COMPONENT.'/helpers/temakorok.php');

//set the default view
$controller = JRequest::getWord('view', 'temakorok');

//add submenu

TemakorokHelper::addSubmenu($controller);	
...
$classname    = 'TemakorokController'.$controller;
