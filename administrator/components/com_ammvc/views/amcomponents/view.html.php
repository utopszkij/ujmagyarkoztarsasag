...
class AmmvcViewAmcomponents  extends JViewLegacy {
	...
	public function display($tpl = null) 
	{
		...
		$context			= 'com_ammvc'.'.'.strtolower($this->getName()).'.list.';
	...
	public function _displayForm($tpl)
	{
		...
		JHTML::stylesheet( 'fields.css', 'administrator/components/com_ammvc/assets/' );
