<?php
/**
 * @version		$Id: categories.php 124 2012-10-08 15:08:17Z michel $
 ...
 * @since		1.6
 */
class AmmvcControllerCategories extends JControllerLegacy
{
	...
	public function __construct($config = array())
	{
		...
		$db = JFactory::getDBO();
		$db->setQuery('SELECT * FROM #__ammvc_categories');
	...
	function access() 
	{
		...
		$extension = $app->getUserStateFromRequest($this->_context.'.filter.extension', 'extension', 'com_ammvc');
	...
	public function ordering()
	{
		...
		if ($return === false) {
			...
			$this->setRedirect('index.php?option=com_ammvc&view=categories&extension='.$extension, $message);
			return true;
		}
	}
