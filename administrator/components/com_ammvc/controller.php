...
class AmmvcController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_ammvc&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_ammvc&view='.$this->_viewname;
				break;
		}
