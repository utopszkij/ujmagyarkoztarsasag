...
// New: 3.1
DEFINE ('_UDDEIM_BADWORD', 'Detekována zakázaná sklova');
DEFINE ('_UDDEADM_BADWORDS_HEAD', 'Filtr zakázaných slov');
DEFINE ('_UDDEADM_BADWORDS_EXP', 'Nové zprávy budou filtrovány na zakázaná slova. Všechna zakázaná slova budou oddělena středníkem (;).');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_14', '...nastavit defaultně seznam zakázaných slov');
DEFINE ('_UDDEADM_OOD_PB', 'Plugin Postboxu je zastaralý!');

// New: 3.0
DEFINE ('_UDDEADM_UDDEIM', 'uddeIM');
DEFINE ('_UDDEADM_REPLYTEXT_HEAD', 'Automatická odpověď');
DEFINE ('_UDDEADM_REPLYTEXT_EXP', 'Při odpovědi na zprávu bude původní text zprávy automaticky přiložen k odpovědi.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_13', '...nastavit jako defaultní pro odpovědi (volitelně)');
