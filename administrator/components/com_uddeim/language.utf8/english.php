...
// New: 2.3
DEFINE ('_UDDEADM_CC_HEAD', 'Button "Show recipients"');
DEFINE ('_UDDEADM_CC_EXP', 'When enabled a user can choose if uddeIM shall add a "Recipients:" line containing all recipients to a message or not.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_9', '...set default for "Recipients:" line, and moderation');
...
DEFINE ('_UDDEADM_WAITDAYS_EXP', 'Specify how many days a registered user must wait until he is allowed to send messages (for 3 hours enter 0.125).');
...
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', 'Report Center');
...
DEFINE ('_UDDEIM_HELP_HEADLINE2', 'Short overview about all functions');
DEFINE ('_UDDEIM_HELP_INBOX', 'The <b>Inbox</b> holds all your incoming messages, every email you receive is located there.');
DEFINE ('_UDDEIM_HELP_OUTBOX', 'The <b>Outbox</b> keeps a copy of every message you send, you can come back to it at any time and see what you\'ve sent.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', 'The <b>Trashcan</b> holds all deletes messages. Messages are not deleted immediately and kept for a certain period of time. As long as the message is stored in the trashcan, you are able to restore it.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', 'The <b>Archive</b> holds all your archived messages from the inbox. You can only archive messages from your inbox. When you need to archive a message written by yourself, ensure that you have selected <i>copy to me</i> when sending it.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>Contacts</b> allows to maintain contact lists (also known as distribution lists). These lists allow to send PMs to multiple recipients. Instead of adding multiple recipients, you can simply enter <i>#listname</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>Settings</b> comprises all configurable user options..');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Compose</b> allows to create a new private message.');
DEFINE ('_UDDEIM_HELP_IREAD', 'The message has been read (you can toggle the status).');
DEFINE ('_UDDEIM_HELP_IUNREAD', 'The message is still unread (you can toggle the status).');
DEFINE ('_UDDEIM_HELP_OREAD', 'The message has been read.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'The message is still unread. Unread messages can be recalled.');
DEFINE ('_UDDEIM_HELP_TREAD', 'The message has been read.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'The message is still unread.');
DEFINE ('_UDDEIM_HELP_FLAGGED', 'Message has been flagged, e.g. when it is an important message (you can toggle the status).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', '<i>Normal</i> message (you can toggle the status).');
DEFINE ('_UDDEIM_HELP_ONLINE', 'The user is currently online.');
DEFINE ('_UDDEIM_HELP_OFFLINE', 'The user is currently offline.');
DEFINE ('_UDDEIM_HELP_DELETE', 'Delete a message (move message to trashcan).');
DEFINE ('_UDDEIM_HELP_FORWARD', 'Forward a message to another recipient.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Archive a message. Archived messages will not be deleted automatically when the admin has configured a timelimit for messages stored in the inbox.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Unarchive a message. The message will be moved back into the inbox.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Recall a message. Send messages can be recalled when they have not been read by the recipient yet.');
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Recycle a message (move message from trashcan back to inbox or outbox).');
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Configuration of the email notification when a new message arrives.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'When the autoresponder is enabled each received message will be immediatly answered.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', 'New messages can be forwarded to another user automatically.');
DEFINE ('_UDDEIM_HELP_BLOCKING', 'You can block users. These users can not send private messages to you.');
DEFINE ('_UDDEIM_HELP_MISC', 'Here you find some more configuration settings');
DEFINE ('_UDDEIM_HELP_FEED', 'You can access your inbox using a RSS feed.');
...
DEFINE ('_UDDEIM_RSS_INTRO1', 'You can access your inbox using a RSS feed (0.91).');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'The access URL is:');
DEFINE ('_UDDEIM_RSS_INTRO2', 'Do not give this URL to other users because it allows to access your inbox.');
DEFINE ('_UDDEIM_RSS_FEED', 'RSS Message Feed');
DEFINE ('_UDDEIM_RSS_NOOBJECT', 'No object error...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', 'User blocked...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', 'Access not allowed...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', 'Wrong username or password...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', 'No Messages');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', 'No new messages');
...
DEFINE ('_UDDEIM_PMNAV_DELETED', 'Message not available');
DEFINE ('_UDDEIM_PMNAV_EXISTS', 'jump to message');
...
DEFINE ('_UDDEMODULE_7DAYS', ' messages last 7 days');
DEFINE ('_UDDEMODULE_30DAYS', ' messages last 30 days');
DEFINE ('_UDDEMODULE_365DAYS', ' messages last 365 days');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Note:<br />When using mosMail, you have to configure a valid email address!</b>');
DEFINE ('_UDDEIM_FILTEREDMESSAGE', 'message filtered');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', 'messages filtered');
DEFINE ('_UDDEIM_FILTER', 'Filter:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', 'Show from this user only');
DEFINE ('_UDDEIM_FILTER_TITLE_OUTBOX', 'Show to this user only');
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'unread only');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Filter');
DEFINE ('_UDDEIM_FILTER_ALL', '- all -');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>You have no%s messages%s in your%s.</b>');	// see next  six lines
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' unread');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' from this user');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_TO', ' to this user');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' inbox');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUTBOX', ' outbox');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' archive');
DEFINE ('_UDDEIM_TODP_TITLE', 'Recipient');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'One or more recipients (comma separated)');
...
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Enable Autoresponder');
DEFINE ('_UDDEIM_AUTORESPONDER', 'Autoresponder');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'When the autoresponder is enabled each received message will be immediatly answered.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Sorry, I am currently not available.\nI will process my mailbox as soon as possible.");
DEFINE ('_UDDEADM_USERSET_AUTOR', 'AutoR');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- AutoR -');
DEFINE ('_UDDEIM_USERBLOCKED', 'User is blocked.');
...
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Enable Autoforwarding');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'AutoF');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- AutoF -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'Autoforwarding');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'New messages can be forwarded to another user automatically.');
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'This specifies how uddeIM loads MooTools (MooTools is required for Autocompleter): <i>None</i> is useful when your template loads MooTools, <i>Auto</i> is the recommended default, when using J1.0 you can also force loading MooTools 1.1 or 1.2.');
...
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_1', '...set default for MooTools');
...
DEFINE ('_UDDEADM_SHOWLINK_EXP', 'All usernames showing up in uddeIM will be displayed as links to the user profile of the selected system.');
DEFINE ('_UDDEADM_SHOWPIC_HEAD', 'Show thumbnails');
DEFINE ('_UDDEADM_SHOWPIC_EXP', 'The thumbnail taken from the selected system of the user will be displayed when reading a message.');
...
DEFINE ('_UDDEIM_ADDCCINFO', 'Add "Recipients:"');
DEFINE ('_UDDEIM_CC', 'Recipients:');
...
DEFINE ('_UDDEADM_TIMEDELAY_EXP', 'Time in seconds a registered user must wait before he can post the next message (0 for no time delay).');
...
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Sent messages kept for');
...
DEFINE ('_UDDEIM_NOMESSAGES_INBOX', 'You have no messages in your inbox.');
...
DEFINE ('_UDDEADM_DELETEREADAFTER_HEAD', 'Read messages kept for');
DEFINE ('_UDDEADM_DELETEUNREADAFTER_HEAD', 'Unread messages kept for');
DEFINE ('_UDDEADM_DELETETRASHAFTER_HEAD', 'Messages kept in trash for');
...
DEFINE ('_UDDEADM_DELETIONS', 'Deletion');
...
DEFINE ('_UDDEADM_TRASHORIGINAL_EXP', 'When activated this will put a checkbox next to the \'Send\' button called \'trash original\' that is checked by default. In this case a message will immediately be moved from the inbox to trashcan when a reply has been sent. This function reduces the number of messages kept in the database. Users can uncheck the box if they want to keep a message in the inbox.');
...
DEFINE ('_UDDEIM_SYSGM_SHORTHELP', 'Usage <b>in system messages only</b>:<br /> [b]<b>bold</b>[/b] [i]<em>italic</em>[/i]<br />[url=http://www.someurl.com]some url[/url] or [url]http://www.someurl.com[/url] are links');
...
DEFINE ('_UDDEIM_EXPORT_NOW', 'send e-mail');
