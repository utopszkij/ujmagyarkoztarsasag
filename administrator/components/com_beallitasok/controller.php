<?php
/**
 * @version		$Id:controller.php 1 2014-04-11Z FT $
 * @author	   	Fogler Tibor
 * @package    Beallitasok
...
/**
 * Beallitasok Standard Controller
 *
 * @package Beallitasok   
 * @subpackage Controllers
 */
class BeallitasokController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_beallitasok&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_beallitasok&view='.$this->_viewname;
				break;
		}
