...
//include Helper
require_once(JPATH_COMPONENT.'/helpers/szavazasok.php');

//set the default view
$controller = JRequest::getWord('view', 'szavazasok');

//add submenu

SzavazasokHelper::addSubmenu($controller);	
...
$classname    = 'SzavazasokController'.$controller;
