<?php
/**
 * @version		$Id:controller.php 1 2014-04-13Z FT $
 * @author	   	Fogler Tibor
 * @package    Szavazasok
...
/**
 * Szavazasok Standard Controller
 *
 * @package Szavazasok   
 * @subpackage Controllers
 */
class SzavazasokController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_szavazasok&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_szavazasok&view='.$this->_viewname;
				break;
		}
