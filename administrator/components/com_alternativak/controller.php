<?php
/**
 * @version		$Id:controller.php 1 2014-04-24Z FT $
 * @author	   	Fogler Tibor
...
/**
 * Alternativak Standard Controller
 *
 * @package Alternativak   
 * @subpackage Controllers
 */
class AlternativakController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_alternativak&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_alternativak&view='.$this->_viewname;
				break;
		}
