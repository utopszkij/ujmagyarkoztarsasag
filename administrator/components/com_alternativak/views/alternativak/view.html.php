...
class AlternativakViewAlternativak  extends JViewLegacy {
	...
	public function display($tpl = null) 
	{
		...
		$context			= 'com_alternativak'.'.'.strtolower($this->getName()).'.list.';
	...
	public function _displayForm($tpl)
	{
		...
		JHTML::stylesheet( 'fields.css', 'administrator/components/com_alternativak/assets/' );
