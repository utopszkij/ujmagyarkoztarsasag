...
class KepviselokModel  extends JModelLegacy { 
	...
	*/
	...
	protected function _buildQuery()
	{
		...
		$this->_query->select('a.*,t.megnevezes,u1.name uname,u2.name kname');
		$this->_query->from($this->_default_table.' AS a
       left outer join #__temakorok AS t on t.id = a.temakor_id
       left outer join #__users AS u1 on u1.id = a.user_id
       left outer join #__users AS u2 on u2.id = a.kepviselo_id'
    );
