...
/**
 * Kepviselok Standard Controller
 *
 * @package Kepviselok   
 * @subpackage Controllers
 */
class KepviselokController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_kepviselok&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_kepviselok&view='.$this->_viewname;
				break;
		}
