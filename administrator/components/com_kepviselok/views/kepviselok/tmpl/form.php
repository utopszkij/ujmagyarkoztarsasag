...
JToolBarHelper::title(   JText::_( 'Kepviselok' ).': <small><small>[ ' . $text.' ]</small></small>' );
	 	...
	 	<div class="col <?php if(version_compare(JVERSION,'3.0','lt')):  ?>width-60  <?php endif; ?>span8 form-horizontal fltlft">
		  <fieldset class="adminform">
			<legend><?php echo JText::_( 'Details' ); ?></legend>
				...
				<?php echo $this->form->getLabel('kepviselo_id'); ?>
				
				<?php echo $this->form->getInput('kepviselo_id');  ?>
				...
				<?php echo $this->form->getLabel('lejarat'); ?>
				
				<?php echo $this->form->getInput('lejarat');  ?>
