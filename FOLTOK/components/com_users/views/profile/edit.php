 ...
 * FT 2015.12.31. SSO -s accountoknál a jelszó nem változtatható
 */
				...
				<?php else : ?>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php endif; ?>
							<?php 
							//+ SSO -s accountoknál a jelszó nem változtatható
								if (($field->fieldname == 'password1') & (substr($user->params,0,6) == '{"SSO"')) {
									echo 'A jelszó az SSO rendszerben változtatható';
								} else if (($field->fieldname == 'password2') & (substr($user->params,0,6) == '{"SSO"')) {
									echo '';
								} else {
									echo $field->input;
								}
