...
//2015.05.07 Fogler Tibor modositása
// eddig csak a user legnygobb usergroup.id értékét vizsgálta, hogy arra megengedett-e az adott comment akció
// most az összest megnézi, és ha egyben is megengedett akkor megengedi. 
...
class JCommentsACL
{
	...
	public static function check($str, $isName = true)
	{
		...
		if ($isName) {
			$str = JCommentsFactory::getConfig()->get($str);  // felteszem: str lista azon groupokról akik a "str" akcióra jogosultak 
		}
