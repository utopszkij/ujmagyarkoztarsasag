...
class KepviselojeloltekViewKepviselojeloltek  extends JViewLegacy {
	...
	public function display($tpl = null) 
	{
		...
		$context			= 'com_kepviselojeloltek'.'.'.strtolower($this->getName()).'.list.';
	...
	public function _displayForm($tpl)
	{
		...
		JHTML::stylesheet( 'fields.css', 'administrator/components/com_kepviselojeloltek/assets/' );
