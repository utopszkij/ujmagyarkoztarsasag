...
/**
 * Kepviselojeloltek Standard Controller
 *
 * @package Kepviselojeloltek   
 * @subpackage Controllers
 */
class KepviselojeloltekController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_kepviselojeloltek&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_kepviselojeloltek&view='.$this->_viewname;
				break;
		}
