...
// condorce eljárás
// ============================================================================
include (JPATH_COMPONENT.'/condorcet.php');

echo '<h3>Condorcet - Shulze kiértékelés</h3>
     <p><a href="http://hu.wikipedia.org/wiki/Condorcet-m%C3%B3dszer" target="new">A Condorcet - Shulze eljárás leírását lásd itt</a></p>';
...
$res = $db->loadObjectList();
if (count($res) == 0) {
  // ha nincs; most  hozzuk létre és tároljuk a cahe -ba
