...
<br />
     ...
     <?php if ($this->_tpl_vars['form']['financial_account_id']['html']): ?>
...
<br />
            ...
            <?php elseif ($this->_tpl_vars['form']['value']['html']): ?>
              <tr class="crm-admin-options-form-block-value">
                <td class="label"><?php echo $this->_tpl_vars['form']['value']['label']; ?>
</td>
                <td><?php echo $this->_tpl_vars['form']['value']['html']; ?>
<br />
                    <span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>The option value is stored in your database.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
                </td>
              </tr>
            <?php endif; ?>
