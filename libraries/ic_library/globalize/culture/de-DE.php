<?php
/** 
 *	iCagenda Globalization de-DE (GERMAN)
 *----------------------------------------------------------------------------
...
defined( '_JEXEC' ) or die( 'Restricted access' );
			...
			$dateglobalize_7 = 'Montag, 22. April 1996';
			$datevalue_7 = 'l , _ j . _ F _ Y';

			$dateglobalize_8 = 'Montag, 22 April';
			$datevalue_8 = 'l , _ j _ F';

			$dateglobalize_11 = 'Mo, 22. Apr 1996';
			$datevalue_11 = 'D , _ j . _ M _ Y';

			$dateglobalize_12 = 'Mo, 22 Apr';
