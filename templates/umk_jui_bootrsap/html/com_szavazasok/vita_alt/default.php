...
<div class="vita1List">
	...
	<div class="kozepsoTerulet">
		...
		<?php	
		  ...
		  //DBG echo $this->itemLink.'<br><br>';
		?>
		
		<div class="vitakList">
			<div class="fulek">
				<div class="aktivFul">Viták (<?php echo $this->Total; ?>)</div>
		...
		<?php
		  ...
		  $db->setQuery('select sz.id, sz.temakor_id, sz.megnevezes, sz.leiras, sz.szavazas_vege, sz.titkos, 
