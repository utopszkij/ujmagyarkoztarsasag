<?php
/**
 * szavazasok publikálásra várnak állapotban böngésző képernyő
 * bemenet:
 * $this->Items
 *      ->Akciok      [name=>link,...]
 *      ->reorderLink
...
<div class="vita1List">
	...
	<div class="kozepsoTerulet">
		...
		<div class="vitakList">
			<div class="fulek">
				<div class="inaktivFul">
					<a href="<?php echo JURI::base(); ?>index.php?option=com_szavazasok&view=vita_alt&task=vita_alt&temakor=<?php echo $this->temakor_id; ?>">
					Viták (<?php echo $vTotal; ?>)
					</a>
				</div>
				<div class="inaktivFul">
							...
							<?php foreach ($this->Items as $item) : ?> 
								...
								<tr class="<?php echo $rowClass.$surgos; ?>">
									<td class="vitaItem">
									  ...
									  <div class="rejtett _hatarido">
									    <?php echo str_replace('-','.',$item->vita1_vege); ?>
									  </div>
									  <div class="rejtett _hatravan">
									     szavazásig még&nbsp;<var><?php echo $item->hatravan; ?></var>&nbsp;nap
									  </div>
									  <div class="rejtett _ertekeles"><?php
		...
		<?php
		  ...
		  $db->setQuery('select sz.id, sz.megnevezes, sz.leiras, sz.szavazas_vege, sz.titkos, 
		  ...
		  where '.$filter.' and sz.szavazas=1
		  order by sz.szavazas_vege ASC
		  limit 5');
		  $Items = $db->loadObjectList();
		  //DBG echo '<br>'.$db->getQuery().'<br>';
		  $rowClass = 'row0';
		?>
		<div class="frissSzavazasok">
			<div class="fulek">
		...
		</div><!-- friss szavazások -->
		<?php if ($szTotal > 5) : ?>
		<div class="szavazasokLink">
		  <a href="<?php echo JURI::base(); ?>index.php?option=com_szavazasok&view=szavazas_folyik&task=szavazas_folyik&temakor=<?php echo $this->temakor_id; ?>">
		     További szavazások
		  </a>
		</div>
		<?php endif; ?>
