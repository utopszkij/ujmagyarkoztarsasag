<?php
/**
 * szavazasok lezárt szavazás állapotban böngésző képernyő
 * bemenet:
 * $this->Items
 *      ->Akciok      [name=>link,...]
 *      ->reorderLink
			...
			<div class="fulek">
				<div class="inaktivFul">
				   <a href="<?php echo JURI::base(); ?>index.php?option=com_szavazasok&view=szavazas_folyik&task=szavazas_folyik&temakor=<?php echo $this->temakor_id; ?>">
					Szavazások (<?php echo $szTotal; ?>)
				   </a>	
				</div>
				<div class="aktivFul">
				    Lezárt szavazások (<?php echo $this->Total; ?>)
				</div>
			</div>
			<div class="clr"></div>
			<div class="tablazat">
					  ...
					  <?php foreach ($this->Items as $item) : ?> 
							  ...
							  <tr class="<?php echo $rowClass.$surgos; ?>">
								  <td class="szavazasItem">
								    ...
								    <div class="hatarido">
									  szavazás lezárva:&nbsp;<b><?php echo str_replace('-','.',$item->szavazas_vege); ?></b>
									</div>
